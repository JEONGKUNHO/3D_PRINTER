...
public class companyReview3 extends AppCompatActivity implements View.OnClickListener {

    private RecyclerView recyclerView;
    private RecyclerView.Adapter adapter;
    private RecyclerView.LayoutManager layoutManager;
    private ArrayList<Review3> arrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.company_review3);
        ...
        databaseReference = database.getReference("Review3");
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {//반복문으로 데이터 List를 추출해냄
                    Review3 review = snapshot.getValue(Review3.class); //만들어뒀던 Company객체에 데이터를 담는다
        ...
        adapter = new ReviewAdapter3(arrayList, this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.plusReview:
                startActivity(new Intent(this, plusReview3.class));
        }
    }
}
