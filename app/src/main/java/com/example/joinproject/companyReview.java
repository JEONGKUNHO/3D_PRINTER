...
public class companyReview extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.company_review);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {//반복문으로 데이터 List를 추출해냄
                    Review review = snapshot.getValue(Review.class); //만들어뒀던 Company객체에 데이터를 담는다
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.plusReview:
                startActivity(new Intent(this, plusReview.class));
        }
    }
}
