...
public class CompanyMenu2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.company_menu2);
        companyName = findViewById(R.id.companyName);
        companyName.setText("Zortrax");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.gallery:
                ...
                Intent intent1 = new Intent(this, companyGallery2.class);
            ...
            case R.id.review:
                Intent intent3 = new Intent(this, companyReview2.class);
