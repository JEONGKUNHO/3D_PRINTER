...
public class ReviewAdapter3 extends RecyclerView.Adapter<ReviewAdapter3.ReviewViewHolder> {

    private ArrayList<Review3> arrayList;
    private Context context;


    public ReviewAdapter3(ArrayList<Review3> arrayList, Context context) {
    ...
    public ReviewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.review_item3, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ReviewViewHolder holder, final int position) {
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), ReviewDetail3.class);
