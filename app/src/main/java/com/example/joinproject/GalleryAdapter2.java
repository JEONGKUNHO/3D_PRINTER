...
public class GalleryAdapter2 extends RecyclerView.Adapter<GalleryAdapter2.GalleryViewHolder> {
    ...
    public GalleryAdapter2(ArrayList<Gallery2> arrayList, Context context) {
    ...
    public GalleryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.gallery_item2,parent,false);
    ...
    public void onBindViewHolder(@NonNull GalleryViewHolder holder, final int position) {
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(v.getContext(),GalleryDetail2.class);
