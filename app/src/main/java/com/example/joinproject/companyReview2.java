...
public class companyReview2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.company_review2);
        ...
        databaseReference = database.getReference("Review2");
        ...
        adapter = new ReviewAdapter2(arrayList, this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.plusReview:
                startActivity(new Intent(this, plusReview2.class));
        }
    }
}
