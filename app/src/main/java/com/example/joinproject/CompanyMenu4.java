...
public class CompanyMenu4 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.company_menu4);
        companyName = findViewById(R.id.companyName);
        companyName.setText("Carbon3D");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.gallery:
                ...
                Intent intent1 = new Intent(this, companyGallery4.class);
            ...
            case R.id.review:
                Intent intent3 = new Intent(this, companyReview4.class);
