...
public class ReviewAdapter4 extends RecyclerView.Adapter<ReviewAdapter4.ReviewViewHolder> {

    private ArrayList<Review4> arrayList;
    private Context context;


    public ReviewAdapter4(ArrayList<Review4> arrayList, Context context) {
    ...
    public ReviewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.review_item4, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ReviewViewHolder holder, final int position) {
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), ReviewDetail4.class);
